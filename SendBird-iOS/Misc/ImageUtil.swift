...
extension UIImageView {
    ...
    func setProfileImageView(for user: SBDUser) {
        if let url = URL(string: ImageUtil.transformUserProfileImage(user: user)){
           // UserDefaults.standard.set(url, forKey: "UserProfileImageURL") //setObject
            let ursString:String = url.absoluteString
            UserDefaults.standard.set(ursString, forKey: "UserProfileImageURL")
