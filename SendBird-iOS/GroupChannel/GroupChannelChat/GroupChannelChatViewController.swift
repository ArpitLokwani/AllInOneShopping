...
//img_btn_channel_settings
        ...
        self.settingBarButton = UIBarButtonItem(image: UIImage(named: ""), style: .plain, target: self, action: #selector(GroupChannelChatViewController.clickSettingBarButton(_:)))
